...
Returning to the original ANOVAs that we ran, I need to check to see if they follow our expectations of what an ANOVA should have.

#### Looking at `m4`

First, I compare the highest standard deviation in beak length grouped by lifestyle and divided it by the lowest
